...
import { MapPin, Phone, User, ChevronLeft, ShieldCheck, Truck, Tag, X, Ticket, Info, ChevronRight } from "lucide-react"
...
const Checkout = () => {
    ...
    const [form, setForm] = useState({
        full_name: "", phone: "", line1: "", line2: "", city: "", state: "", postal_code: "", country: "India",
    })
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-32 space-y-8">
                        <div className="bg-[#F9F9F9] rounded-[2.5rem] p-8 md:p-10 border border-gray-100 shadow-sm">
                            ...
                            <button form="checkout-form" type="submit" className="w-full bg-black text-white py-5 rounded-full font-bold text-[11px] uppercase tracking-[0.2em] hover:bg-gray-800 transition-all transform active:scale-[0.98] shadow-xl shadow-black/10 mt-10">
                                Place Order (COD)
                            </button>
                        </div>
                    </div>
